...
export default function DetailsView({ postId, updateIsModifying }) {
    ...
    const handlePostClick = async () => {
        ...
        try {
            ...
            const apiUrl = `https://admin-api.crystalmine.kr/department/posts/${postId}`;
        ...
        <DetailsViewWrap>
            ...
            <PostContainer>
                ...
                <ButtonWrap1>
                    ...
                    />
                    {!isModifying && (
                        <Button width="120px" height="28px" fontSize="14px" onClick={handleDeleteClick}>
                            게시글 삭제
                        </Button>
                    )}
                    {isModifying && (
                        <Button width="120px" height="28px" fontSize="14px" onClick={handleCancelPostClick}>
                            취소
                        </Button>
                    )}
                    {isModifying && (
                        <Button width="120px" height="28px" fontSize="14px" onClick={handlePostClick}>
                            등록하기
                        </Button>
                    )}
                </ButtonWrap1>
