...
export default function Writing() {
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post(`https://admin-api.crystalmine.kr/department/posts`, null, {
                headers: {
    ...
    return (
        <WritingWrap>
            ...
            <ButtonWrap1>
                <Button width="120px" height="28px" fontSize="14px" onClick={handleCancel}>
                    취소
                </Button>
                <Button width="120px" height="28px" fontSize="14px" onClick={handleSubmit}>
                    등록하기
                </Button>
            </ButtonWrap1>
        </WritingWrap>
