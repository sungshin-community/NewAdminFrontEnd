  ...
  useEffect(() => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const apiUrl = `https://admin-api.crystalmine.kr/department/posts`;
    ...
    const fetchData = async (page, searchKeyword) => {
        try {
            let apiUrl = `https://admin-api.crystalmine.kr/department/posts?page=${page - 1}`;
        ...
        <PostMannagerWrap>
            ...
            <div>
                ...
                <SearchBoxWrap>
                    ...
                    <Button width="120px" height="28px" fontSize="14px" onClick={handleSearchButtonClick}>
                        검색
                    </Button>
                </SearchBoxWrap>
            </div>
                    ...
                    >
                        <ListBoxWrap even={index % 2 === 0}>
                            ...
                            <TableBox style={{ flex: 1 }}>
                                {data.content.length > 15 ? `${data.content.slice(0, 15)}...` : data.content}
                            </TableBox>
                        </ListBoxWrap>
                    </ClickablePost>
                ))}
